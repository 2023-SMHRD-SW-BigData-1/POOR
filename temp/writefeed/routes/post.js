...
const write = async (req, res) => {
    try {
        ...
        const insertSql = "INSERT INTO t_post (post_title, post_content, post_img, post_views, created_at, user_id, post_likes, post_seq) VALUES (:title, :content, 'post_img 1', 1, sysdate, :id, 1 ,post_seq.NEXTVAL)"
